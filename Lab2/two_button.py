...
#  start and quit button and control for animation
#========================================================
import sys
...
pygame.display.flip()
#initialize control singal
running = True
run_two_ball = False
show_coordinate = False
#initialize collision detection delay and coordination
#present period
max_count = 2
count = 0
display_count = 0
